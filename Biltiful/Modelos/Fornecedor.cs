...
namespace Cadastros
{
    public class Fornecedor
    {
        ...
        public Fornecedor(string cnpj, string razaoSocial, char situacao)
        {
        ...
        public Fornecedor(string cnpj, string rSocial, DateTime dAbertura, DateTime ultimaVenda, DateTime dataCadastro, char situacao)
        {
            CNPJ = cnpj;
            RazaoSocial = rSocial;
        ...
        public static string FormataCNPJ(string cnpj) => cnpj.Insert(2, ".").Insert(6, ".").Insert(10, "/").Insert(15, "-");
...
");
        ...
        {
            return CNPJ + RazaoSocial + DataAbertura.ToString("dd/MM/yyyy") + UltimaVenda.ToString("dd/MM/yyyy") + DataCadastro.ToString("dd/MM/yyyy") + Situacao;
        }
